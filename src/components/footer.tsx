  ...
  return (
        ...
        <div className="container max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center sm:text-left">
                ...
                <div className="grid gap-1">
                    <h3 className="font-semibold text-base mb-1">Theo dõi</h3>
            ...
            <div className="border-t border-secondary-foreground dark:border-gray-600 mt-6 pt-4 flex flex-col sm:flex-row items-center justify-center sm:justify-between">
