...
export const sanitizeOptions = {
    ...
    allowedAttributes: {
        ...
        a: ['href', 'target', 'rel'],
        iframe: ['src', 'class', 'width', 'height', 'allowfullscreen', 'autoplay', 'disablekbcontrols', 'enableiframeapi', 'endtime', 'ivloadpolicy', 'loop', 'modestbranding', 'origin', 'playlist', 'start'],
...
export const MenuBar = () => {
    ...
    return (
        <div className="tiptap__buttons">
            ...
            <ImageUploader onUploadSuccess={(url) => {addImage(url);}}
            />
        </div>
    );
}
